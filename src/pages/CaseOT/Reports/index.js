...
import CallSummary from "../../FencingOT/Reports/Content/CallSummary";
...
class Reports extends React.Component {
  constructor(props) {
    ...
    this.fetchJobsForCase(props.selectedCase);
    this.flag();
    console.log(props);
  }
  ...
  state = {
    ...
    dataTableSelectedColumns: [
      ...
      "callingimsi",
      "callingfirstcgi",
      "callingfirstlocationaddress",
      "callinglastcgi",
      "callinglastlocationaddress",
      "callednumber",
      "calledimei",
      "calledimsi",
      "calledfirstcgi",
      "calledfirstlocationaddress",
      "calledlastcgi",
      "calledlastlocationaddress",
      "callduration",
      "timestampdate",
      "timestamptime",
      "servedmsisdn",
      "callingfirstlocationlat",
      "callingfirstlocationlon",
      "callinglastlocationlat",
      "callinglastlocationlon",
      "calledfirstlocationlat",
      "calledfirstlocationlon",
      "calledlastlocationlat",
      "calledlastlocationlon",
      // "sscode",
    ...
    if (
      ...
      return (
        <DataTableContent
          ...
          getRow={this.getRow}
          exportRight={this.state.currentAccount.modules.caseot.export}
  ...
  changeTab = async () => {
    await this.props.changeTab("Case-Intel");
  };
  ...
  getMainContent() {
    switch (this.state.activeWidget) {
      ...
      case "CallSummary":
        return <CallSummary data={this.state.selectedJobCdrList} />;
      default:
        return;
    }
  }
    ...
    return (
      <div>
        ...
        >
          ...
          {rightDrawerOpen &&
          this.state.selectedJob["type"] === "Single Target" ? (
            <div
              style={{
                padding: 10,
                height: "100%",
            ...
            >
              <ExpansionPanel
                ...
                onChange={(event, widgetsExpansionOpen) =>
                  this.setState({
                    widgetsExpansionOpen: !widgetsExpansionOpen,
                  })
                }
                ltExpanded
              >
                ...
                >
                  <CardContent>
                    ...
                    <h4>Job Type: {this.state.selectedJob["type"]}</h4>
    ...
    try {
      ...
      selectedJobCdrList.forEach((cdr) => {
        ...
        cdr.timestamptime = cdr.timestamp
          ...
          : 0;
        cdr.timestampdatetime = cdr.timestamp
          ? moment(cdr.timestamp).format("DD-MMM-YYYY HH:mm:ss")
          : 0;
